  ...
  return (
    <div className="h-screen">
      <Carousel>
        ...
        >
          {/* Left Section: Image */}
          <div className="w-full md:w-1/2 flex justify-center md:justify-end px-4 md:px-10">
            <img
              src="./girl 1.png"
          ...
          <div className="w-full md:w-1/2 text-white flex flex-col justify-center items-start px-4 md:px-10">
