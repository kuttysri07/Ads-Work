        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div data-aos="fade-right" className="border p-5 rounded">
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">
              We create beautiful, responsive websites that provide a seamless
          ...
          <div  data-aos="fade-left" className="border p-5 rounded">
            ...
            <p className="mt-2 text-gray-500">
              We offer expert digital marketing solutions that drive results and
          ...
          <div  data-aos="fade-right" className="border p-5 rounded">
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">
              Our SEO experts will optimize your website to increase traffic,
